...
public class LoginBean {
	...
	private String lastname,address,email,phonenumber,pass_word,user_name;
	...
	public String addUser()
	{
		...
		try{
			...
			String sql = "insert into user(firstname,lastname,address,email,phonenumber,username,password)	VALUES(?,?,?,?,?,?,?)";
